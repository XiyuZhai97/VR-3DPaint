...

{
    ...
    public Teleporter tel; //access navigator to check whether in teleport mode
    ...
    void Update()
    {
        //generate stroke mesh when dominant hand trigger is down if not in teleport mode
        if (!tel.teleportOn)
        {
