...
namespace wvr
{
	...
	public enum WVR_EventType
	{
		...
		WVR_EventType_RecommendedQuality_Lower = 1004,	/**< @ref Notification recommended quality to Lower from runtime. */
		WVR_EventType_RecommendedQuality_Higher = 1005,	/**< @ref Notification recommended quality to Higher from runtime. */
	...
	public class Interop
	{
		...
		/**
		 * @brief Function to eye pose data.
		 * @param WVR_EyePose_t* memory that eye pose data stored
		...
		{
			return WVR_Base.Instance.GetEyePose (ref eyePose);
		}
		#endregion
		...
		{
			return WVR_Base.Instance.EnableAdaptiveQuality(enable);
		}
