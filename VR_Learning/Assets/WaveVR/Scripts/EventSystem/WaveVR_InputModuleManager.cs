...
public class WaveVR_InputModuleManager : MonoBehaviour
{
	...
	private void updateInteractionModeAndGazeTriggerType()
	{
		if (Log.gpl.Print)
		{
			PrintDebugLog (this.OverrideSystemSettings ? "updateInteractionModeAndGazeTriggerType() OverrideSystemSettings is true." : "updateInteractionModeAndGazeTriggerType() OverrideSystemSettings is false.");
			PrintDebugLog (InteractionMode_System == WVR_InteractionMode.WVR_InteractionMode_Gaze ? "updateInteractionModeAndGazeTriggerType() InteractionMode_System is gaze." : "updateInteractionModeAndGazeTriggerType() InteractionMode_System is controller.");
			PrintDebugLog (InteractionMode_User == WaveVR_EInputModule.Controller ? "updateInteractionModeAndGazeTriggerType() InteractionMode_User is controller." : "updateInteractionModeAndGazeTriggerType() InteractionMode_User is gaze.");
			if (gazeTriggerType_System == WVR_GazeTriggerType.WVR_GazeTriggerType_Timeout)
				PrintDebugLog ("updateInteractionModeAndGazeTriggerType() gazeTriggerType_System is timeout.");
			if (gazeTriggerType_System == WVR_GazeTriggerType.WVR_GazeTriggerType_Button)
				PrintDebugLog ("updateInteractionModeAndGazeTriggerType() gazeTriggerType_System is button.");
			if (gazeTriggerType_System == WVR_GazeTriggerType.WVR_GazeTriggerType_TimeoutButton)
				PrintDebugLog ("updateInteractionModeAndGazeTriggerType() gazeTriggerType_System is timeout & button.");
			if (gazeTriggerType_User == WVR_GazeTriggerType.WVR_GazeTriggerType_Timeout)
				PrintDebugLog ("updateInteractionModeAndGazeTriggerType() gazeTriggerType_User is timeout.");
			if (gazeTriggerType_User == WVR_GazeTriggerType.WVR_GazeTriggerType_Button)
				PrintDebugLog ("updateInteractionModeAndGazeTriggerType() gazeTriggerType_User is button.");
			if (gazeTriggerType_User == WVR_GazeTriggerType.WVR_GazeTriggerType_TimeoutButton)
				PrintDebugLog ("updateInteractionModeAndGazeTriggerType() gazeTriggerType_User is timeout & button.");
		}
		if (this.OverrideSystemSettings)
		{
			if ((this.InteractionMode_User != this.CustomInputModule) || (this.preOverrideSystemSettings != this.OverrideSystemSettings))
			{
				...
				{
					this.InteractionMode_User = this.CustomInputModule;
					PrintDebugLog (this.InteractionMode_User == WaveVR_EInputModule.Controller ? "updateInteractionModeAndGazeTriggerType() InteractionMode_User is controller." : "updateInteractionModeAndGazeTriggerType() InteractionMode_User is gaze.");
				}
	...
	private GameObject gazePointer = null;
	private GameObject gazeRing = null;
	...
	public void Update()
	{
		...
		if (InteractionMode_Current != _cur_mode)
		{
			...
			if (InteractionMode_Current == WVR_InteractionMode.WVR_InteractionMode_Controller)
				PrintDebugLog ("Update() InteractionMode_Current is controller.");
			if (InteractionMode_Current == WVR_InteractionMode.WVR_InteractionMode_Gaze)
				PrintDebugLog ("Update() InteractionMode_Current is gaze.");
