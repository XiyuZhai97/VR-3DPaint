...
public class WaveVR_UnityEditor : MonoBehaviour
{
	...
	#region [Event] Right for Press State
	...
	#region [Event] Left for Touch State
	...
	private void SetDevicePosePairHead()
	{
		...
		posePairHead.pose.OriginModel = originModel;
	}
	...
	private void SetDevicePosePairRight()
	{
		...
		posePairRight.pose.OriginModel = originModel;
	}
	...
	private void SetDevicePosePairLeft()
	{
		...
		posePairLeft.pose.OriginModel = originModel;
	}
