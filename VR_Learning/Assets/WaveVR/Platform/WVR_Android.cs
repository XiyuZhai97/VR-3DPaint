...
public class WVR_Android : wvr.Interop.WVR_Base
{
	...
	[DllImportAttribute("wvr_api", EntryPoint = "WVR_GetEyePose", CallingConvention = CallingConvention.Cdecl)]
	...
	{
		return WVR_GetEyePose (ref eyePose);
	}
	#endregion
		...
		{
			return WVR_EnableAdaptiveQuality_Android(enable);
		}
		...
		{
			return WVR_UpdateTexture_Android(textureid);
		}
