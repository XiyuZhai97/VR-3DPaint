...
#if UNITY_EDITOR
public class WVR_Simulator : wvr.Interop.WVR_Base {
	private static string LOG_TAG = "WVR_Simulator";
	...
	[DllImport("wvr_plugins_directpreview", EntryPoint = "WVR_GetTransformFromEyesToHead_S")]
	public static extern WVR_Matrix4f_t WVR_GetTransformFromEyesToHead_S(WVR_Eye eye, WVR_NumDoF dof);
	public override WVR_Matrix4f_t GetTransformFromEyeToHead(WVR_Eye eye, WVR_NumDoF dof)
	{
		return WVR_GetTransformFromEyesToHead_S(eye, dof);
	}
	...
	[DllImport("wvr_plugins_directpreview", EntryPoint = "SetPrintCallback")]
	public static extern void WVR_SetPrintCallback_S(debugcallback callback);

	[DllImport("wvr_plugins_directpreview", EntryPoint = "SetTextureHandleLR")]
	public static extern bool SetTextureHandle(IntPtr[] ttPtr);

	public static void PrintLog(string msg)
	{
		Debug.Log("WVR_Simulator : " + msg);
	}
	// wvr.h
	public override WVR_InitError Init(WVR_AppType eType)
	{
		if (WaveVR.EnableSimulator)
		{
			...
			long startTime = getCurrentTimeMillis();
				...
				Debug.Log(WaveVR_Render.Instance.acturalStereoRenderingPath);
